...
import * as QuickDemo from "./QuickDemo.stories.tsx";

<Meta of={QuickDemo} title="QuickDemo"/>

# QuickDemo

一个用于快速演示的页面.包含一个标题和一个`tab`容器,每个`tab`页对应一个`python`函数.

#### Example

<Canvas of={QuickDemo.Primary}/>
